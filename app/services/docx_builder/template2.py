"""Template 2: Left-aligned name, black accent, underlined sections."""
...
def build(context_path: str, output_path: str) -> None:
    ...
    headers = ("SUMMARY", "WORK EXPERIENCE", "EXPERIENCE", "PROFESSIONAL EXPERIENCE", "EDUCATION", "CERTIFICATIONS")
    first_section = True
